                  ...
                  <div className="absolute left-0 right-0 top-full z-10 mt-1 max-h-56 overflow-auto rounded border border-outline-variant bg-surface shadow-lg">
                    ...
                    <button
                      ...
                      onMouseDown={(e) => {
                        ...
                        if (d.dosage_form) setDosageForm(d.dosage_form);
            ...
            {showMore && (
              <>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <label className="block">
                    <span className="mb-0.5 block text-label-md font-label-md text-on-surface">Unit</span>
                    <input
                      value={unit}
                  ...
                  <label className="block">
                    <span className="mb-0.5 block text-label-md font-label-md text-on-surface">Form</span>
                    <input
                      value={dosageForm}
                  ...
                  <label className="block">
                    <span className="mb-0.5 block text-label-md font-label-md text-on-surface">Route</span>
                    <select
                      value={route}
                    ...
                    >
                      ...
                      {["Oral", "Topical", "Injectable", "Inhalation", "Ophthalmic", "Otic", "Nasal", "Rectal", "Vaginal", "Sublingual", "Other"].map((r) => (
